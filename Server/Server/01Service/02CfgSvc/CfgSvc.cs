...
public class CfgSvc {
    ...
    private void InitGuideCfg() {
        XmlDocument doc = new XmlDocument();
         doc.Load(@"F:\DarkGod\Client\Assets\Resources\ResCfgs\guide.xml");
       // doc.Load(@"C:\Users\Administrator\Desktop\ResCfgs\guide.xml");
    ...
    private void InitStrongCfg() {
        XmlDocument doc = new XmlDocument();
        doc.Load(@"F:\DarkGod\Client\Assets\Resources\ResCfgs\strong.xml");
       // doc.Load(@"C:\Users\Administrator\Desktop\ResCfgs\strong.xml");
        XmlNodeList nodLst = doc.SelectSingleNode("root").ChildNodes;
    ...
    private void InitTaskRewrdCfg() {
        XmlDocument doc = new XmlDocument();
        doc.Load(@"F:\DarkGod\Client\Assets\Resources\ResCfgs\taskreward.xml");
        //doc.Load(@"C:\Users\Administrator\Desktop\ResCfgs\taskreward.xml");
        XmlNodeList nodLst = doc.SelectSingleNode("root").ChildNodes;
    ...
    private void InitMapCfg() {
        XmlDocument doc = new XmlDocument();
        doc.Load(@"F:\DarkGod\Client\Assets\Resources\ResCfgs\map.xml");
        //doc.Load(@"C:\Users\Administrator\Desktop\ResCfgs\map.xml");
        XmlNodeList nodLst = doc.SelectSingleNode("root").ChildNodes;
